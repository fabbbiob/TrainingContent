...
import styles from './FirstOneWebPart.module.scss';
import * as strings from 'FirstOneWebPartStrings';

export interface IFirstOneWebPartProps {
  description: string;
}

export default class FirstOneWebPart extends BaseClientSideWebPart <IFirstOneWebPartProps> {
  ...
  public render(): void {
    ...
    this.context.statusRenderer.displayLoadingIndicator(this.domElement, "sto a caricà...");
            ...
            <div class="${ styles.container }">
              <div class="${ styles.row }">
                <div class="${ styles.column }">
                  ...
                  <a href="#" class="${ styles.button }"> <!-- https://aka.ms/spfx -->
