...
import styles from './MsGraphSpFx.module.scss';
import { IMsGraphSpFxProps } from './IMsGraphSpFxProps';
import { escape } from '@microsoft/sp-lodash-subset';
import { IGraphPersonaState } from '../../graphResponse/components/IGraphPersonaState';
...
export default class MsGraphSpFx extends React.Component<IMsGraphSpFxProps, IGraphPersonaState> {
  ...
  public componentDidMount(): void {
    ...
    .api('me')
    .get(
      (error: any, user: MicrosoftGraph.User, rawResponse?: any) => {
        this.setState( {
