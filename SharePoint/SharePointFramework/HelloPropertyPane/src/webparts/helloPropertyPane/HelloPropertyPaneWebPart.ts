...
export default class HelloPropertyPaneWebPart extends BaseClientSideWebPart <IHelloPropertyPaneWebPartProps> {
        ...
        <div class="${ styles.container }">
          <div class="${ styles.row }">
            <div class="${ styles.column }">
              ...
              <p class="${ styles.description }">I live in : ${escape(this.properties.myContinent)}</p>
              <p class="${ styles.description }">Nbr. of Continents visited: ${this.properties.numContinentsVisited}</p>
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
          ...
          groups: [
            {
              ...
              //       }
              //     )
              ,   new PropertyPaneContinentSelector(
                    'myContinent'
                  , <IPropertyPaneContinentSelectorProps>{
                      label: 'Continent where I currently reside'
                    , disabled: false
      ...
      ,{
        header: {
          description: strings.PropertyPaneDescription + " - 2"
        },
        groups: [
          {
            groupName: strings.BasicGroupName + " - 2",
            groupFields: [
